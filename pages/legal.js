    ...
    <Layout myClass="intro">
		...
		<div className="tips">
			...
			<ul>
				...
				<li><a href="#note-on-maps">Note on maps</a></li>
			</ul>
			...
			<p>Use of this web application, <a href="/">game.projectconnect.world</a> (the "Project Connect Web Application"), constitutes acceptance of the following terms and conditions. Project Connect reserves the right to seek all remedies available by law for any violation of these terms of use, including any violation of Project Connect's rights in the Project Connect name and emblem and its rights in connection with the information, artwork, text, video, audio, or pictures (together, the "Content") of the Project Connect Web Site.</p>

			<p>&nbsp;</p>

			<h4>The Project Connect Name</h4>

			<p>The Project Connect name and emblem are the exclusive property of UNICEF. They are protected under international law. Unauthorized use is prohibited. They may not be copied or reproduced in any way without the prior written permission of UNICEF. Requests for permission should be <a href="mailto:projectconnect@unicef.org">sent to us</a>.</p>

			<p>&nbsp;</p>

			<p><strong>The Project Connect Web Application</strong></p>

			<p>The Project Connect Web Application is provided by UNICEF for personal use and educational purposes only. Any other use, including reproduction or translation of anything more than a de minimis portion of the Content of the Project Connect Web Site, or any use other than for personal or educational purposes, requires the express prior written permission of UNICEF. Requests for permission should be <a href="mailto:projectconnect@unicef.org">sent to us</a>, specifying full details of the proposed use. All Content of the Project Connect Web Application is protected by law including, as applicable, copyright laws.</p>

			<p>The Content of the Project Connect Web Application is selected on the basis of UNICEF's own criteria and in its own sole discretion. UNICEF reserves the right at any time to change or discontinue any aspect or feature of the Project Connect Web Application, including but not limited to these terms of use, hours of availability and equipment needed for use.</p>
			...
			<p>The United Nations and UNICEF disclaim any liability or responsibility arising from the use of the Project Connect Web Application or the Content of the Project Connect Web Application. The United Nations, UNICEF, members of their staff, and their contractors, shall not be liable for any financial or other consequences whatsoever arising from the use of the Content of the Project Connect Web Application, including the inappropriate, improper, or fraudulent use of such Content.</p>

			<p>No representations or warranties of any kind concerning the Project Connect Web Application are given, including responsibility for any infection by virus or any other contamination or by anything which has destructive properties.</p>

			<p>&nbsp;</p>

			<h5>Other Web Sites</h5>

			<p>The Project Connect Web Application may be linked to other web sites that are not under Project Connect's control. Project Connect provides these links merely as a convenience and the inclusion of such links does not imply an endorsement or approval by UNICEF of any web site, product or service. UNICEF does not assume any responsibility or liability in respect of such web sites, including, for example, responsibility or liability for the accuracy or reliability of any information, data, opinions, advice or statements made on those web sites.</p>

			<p>&nbsp;</p>

			<p>If you have any questions about this please <a href="mailto:projectconnect@unicef.org">contact us</a>. Thank you.</p>
			...
			<p>This privacy statement describes Project Connect’s policy concerning the gathering and sharing of visitors’ information through the Project Connect Web Application (webapp), located at <a href="https://game.projectconnect.world" target="_blank">https://game.projectconnect.world</a>.&nbsp; By using the Project Connect webapp you are accepting the practices described in this policy.</p>
			...
			<p>In general, you can browse the Project Connect webapp without telling us who you are or revealing any personal information about yourself.&nbsp; The only information we gather during general browsing is from standard server logs.&nbsp; These include your IP (Internet Protocol) address, domain name, browser type, operating system, and information such as the web site that referred you to us, the pages you visit, and the dates/times of those visits.</p>
			...
			<p>The information gathered during general browsing of the “projectconnect.world” domain is used to analyse trends and usage of the Project Connect site and to improve the usefulness of the site.&nbsp; It is not connected with any personal information. However, if you have registered with Project Connect's webapp, the information we collect about your normal web usage will be identifiable to you.</p>
			...
			<p>At any time, you can cancel or modify your information by &nbsp;<a href="mailto:projectconnect@unicef.org">contacting us</a>.</p>

			<h5>Security</h5>

			<p>We do not sell or share any personally identifiable information volunteered on the Project Connect site to any third party without prior consent.&nbsp; Any information provided to Project Connect by users of the Project Connect's webapp is held with the utmost care and security, and will not be used in ways other than as set forth in this privacy policy, or in ways to which you have explicitly consented.&nbsp; Project Connect employs a range of techniques and security measures to protect the information maintained on our system from loss, misuse, unauthorised access or disclosure, alteration, or destruction.</p>

			<p>However, Project Connect assumes no responsibility for the security of information.</p>

			<p>The Project Connect's webapp contains links to sites external to the projectconnect.world domain. Project Connect is not responsible for the privacy practices or the content of such sites.</p>
			...
			<p>For questions or queries regarding this privacy policy, please&nbsp;<a href="mailto:projectconnect@unicef.org">contact us</a>.</p>
			...
			<p>By visiting or using this web application (webapp), a cookie will be created which Project Connect may use to provide statistics that help us to give you the best experience of our sites. The statement below describes our policy on cookies.</p>
			...
			<p>Project Connect does not collect and analyze the data to create cookies directly; we use a specialist service provider which both collects information on your preferences from your visits to our websites and analyzes your preferences from cookies already stored in your browser.</p>
			...
			<ul><li>Configure how we use your&nbsp;<a href="http://www.google.com/settings/ads">Google Analytics information</a>.</li>
				...
				<li>Alternatively, you can use your browsers’ private browsing mode. Common browsers like Google Chrome, Brave, Safari and Internet Explorer have this functionality.</li>
			</ul>
			...
			<p>There are many websites that provide guidance on how to opt out of the collection and use of your information for promotional purposes that are not limited to Project Connect web properties. For example:</p>
			...
			<p>Maps on this site do not reflect a position by Project Connect on the legal status of any country or territory or the delimitation of any frontiers.</p>
